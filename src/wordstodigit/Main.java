	...
	public static void main(String[] args) {
		...
		//file logic goes here
				...
				while((line = bufferedReader.readLine()) != null){
					...
					for (int i = 0; i < wordsfordigit.length; i++) {//for loop for al words in line. ; seperated.
						
						for (int j = 0; j < digitwordmap.length; j++) {//for loop for checking if words in line has corresponding digit mapped and print it.
