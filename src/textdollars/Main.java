...
public class Main {
  ...
  public static final String[] less20    = { "One",
											 "Two",
											 "Three",
											 "Four",
											 "Five",
	...
	public static void main(String[] args) {
		...
		while((line = bufferedReader.readLine()) != null){
			...
			System.out.println(dollarsToText(Integer.parseInt(line))+"Dollars");
	...
	public static String dollarsToText(int num){
		...
		if(num < 20 && num > 0){
			...
			if (num >= 20 && num < 30){ result = "Twenty";}
			if (num >= 30 && num < 40){ result = "Thirty";}
			if (num >= 40 && num < 50) { result = "Forty";}
			if (num >= 50 && num < 60){ result = "Fifty";}
			if (num >= 60 && num < 70){ result = "Sixty";}
			if (num >= 70 && num < 80){ result = "Seventy";}
			if (num >= 80 && num < 90){ result = "Eighty";}
			if (num >= 90){ result = "Ninety";}
			if(num % 10 !=0){
