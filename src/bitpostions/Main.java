...
/**
 * Bitposition challenge problem.
 *
 * @author Vijay Kakadiya
 */
public class Main {
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				if (inputArgs.length != 3) {
					System.out
							.println("File not correct. Input in wrong format\n'");
					break;
				}
	...
	private static boolean bitPositions(Integer number, Integer pos1,
			Integer pos2) {
