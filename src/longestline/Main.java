...
public class Main {
	...
	public static void main(String[] args) {
		...
		//file logic goes here
				...
				int max_print = Integer.parseInt(bufferedReader.readLine()); //first line containing max lines to print 
				String string_start = bufferedReader.readLine(); //First string in file
