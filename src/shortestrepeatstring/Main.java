...
public class Main {
	...
	public static int searchSmallRepeatString(String inline) {
    	...
    	for(int i = 0; i < inline.length() - smallsequence; i++) {
    		String String1 = inline.substring(0, smallsequence); //Start with smallest possible sequence to find common sequence and increment substring untill find smallest common subsequence
    		String Strring2 = inline.substring(smallsequence, smallsequence + smallsequence);
